  ...
  return (
    ...
    >
      ...
      <div className="contact-grid">
        {contacts.map((c, i) => (
          ...
          >
            ...
            <svg className="contact-arrow" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <footer className="site-footer">
        <p>Designed & Built by Amar Sinha</p>
      </footer>
    </section>
  )
}
